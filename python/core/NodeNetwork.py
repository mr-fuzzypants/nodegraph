...
class NodeNetwork(Node):
    ...
    def add_data_input_port(self, port_name: str) -> InputDataPort:
        ...
        port = InputDataPort(self.id, port_name)
        port.allow_multiple = True
        self.inputs[port_name] = port
        return port

    def add_data_output_port(self, port_name: str) -> OutputDataPort:
        ...
        port = OutputDataPort(self.id, port_name)
        port.allow_multiple = True
